...
!---------------------------------------------------------------------------------------------------
!   Public subroutine lists:    open_xmldoc
!                               close_xmldoc
!                               check_for_node
!                               get_node_ptr
!                               get_node_list
...
!                               get_node_value
!                               get_node_array
!                               get_arraysize_integer
!                               get_arraysize_double
!                               get_arraysize_string
!
!   Public type lists:          Node
!                               NodeList
!
!===================================================================================================
...
!!!
!!!        type(Node), pointer, intent(in out)  :: ptr
...
!!!        type(Node), pointer, intent(in) :: ptr
!!!        character(len=*), intent(in)    :: node_name
!!!        integer, intent(in out)         :: result_int
!!!        
!!!        integer :: node_type
!!!        logical :: found
!!!        type(Node), pointer :: temp_ptr
...
!!!        if (.NOT. found) then
!!!            call a_error%set (INFO_LIST_INPUT, "Node " // node_name // " not part of Node " // getNodeName(ptr))
...
!!!        type(Node), pointer, intent(in) :: ptr
!!!        character(len=*), intent(in)    :: node_name
!!!        integer(8), intent(in out)      :: result_long
!!!        
!!!        integer :: node_type
!!!        logical :: found
!!!        type(Node), pointer :: temp_ptr
...
!!!        type(Node), pointer, intent(in) :: ptr
!!!        character(len=*), intent(in)    :: node_name
!!!        real(8), intent(in out)         :: result_double
!!!        
!!!        integer :: node_type
!!!        logical :: found
!!!        type(Node), pointer :: temp_ptr
...
!!!        type(Node), pointer, intent(in)  :: ptr
!!!        character(len=*), intent(in)     :: node_name
!!!        character(len=*), intent(in out) :: result_string(:)
!!!        
!!!        integer :: node_type
!!!        logical :: found
!!!        type(Node), pointer :: temp_ptr
...
!!!        type(Node), pointer, intent(in)  :: ptr
!!!        character(len=*), intent(in)     :: node_name
!!!        character(len=*), intent(in out) :: result_str
!!!        
!!!        integer :: node_type
!!!        logical :: found
!!!        type(Node), pointer :: temp_ptr
